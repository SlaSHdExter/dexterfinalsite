        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <a class="btn btn-outline-primary" href="ajouterClient.php">AJOUTER</a>
                      ...
                      <table id="order-listing" class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <label class="badge badge-info"><?php echo $row['etat'];  ?></label>
                            </td>
                            <td>
                              <a class="btn btn-outline-primary" href="modiferCL.php?id=<?php echo $row['id']; ?>">Modifer</a>
                               <a class="btn btn-outline-dark" href="supprimerCL.php?id=<?php echo $row['id']; ?>">Supprimer</a>
                            </td>
                          </tr>
 <?php }  ?>
