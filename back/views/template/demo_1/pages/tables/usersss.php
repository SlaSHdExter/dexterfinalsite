              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"><a href="ajouterClient.php"> Ajouter utilisateur</a> </p>
                          ...
                          <tr>
                           ...
                           <?php echo $row['prenom'];  ?>
                            ...
                            <td> <?php echo  MD5($row['password']);  ?></td>
                             <td> <a href="modiferCL.php?id=<?php echo $row['id']; ?>">MODIFER</a>- <a href="supprimerCL.php?id=<?php echo $row['id']; ?>">SUPPRIMER</a></td>
                          </tr>
                       <?php }  ?>
                        </tbody>
                      </table>
