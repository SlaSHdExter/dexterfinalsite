...
<!-- Mirrored from www.bootstrapdash.com/demo/breeze/jquery/template/demo_1/pages/forms/basic_elements.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Nov 2019 21:18:33 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
          <a class="sidebar-brand brand-logo" href="../../index.html"><img src="http://www.bootstrapdash.com/demo/breeze/jquery/template/assets/images/logo.svg" alt="logo" /></a>
          <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="../../index.html"><img src="http://www.bootstrapdash.com/demo/breeze/jquery/template/assets/images/logo-mini.svg" alt="logo" /></a>
        </div>
        <ul class="nav">
          <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
              ...
              <div class="nav-profile-text d-flex flex-column pr-3">
                ...
                <span class="font-weight-normal">$8,753.00</span> </div>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="forms">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="advanced_elements.html">Advanced Forms</a>
                </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="http://bootstrapdash.com/demo/breeze/jquery/documentation/documentation.html">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar col-lg-12 col-12 p-lg-0 fixed-top d-flex flex-row">
          <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
            <a class="navbar-brand brand-logo-mini align-self-center d-lg-none" href="../../index.html"><img src="http://www.bootstrapdash.com/demo/breeze/jquery/template/assets/images/logo-mini.svg" alt="logo" /></a>
              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="ajouterCL.php" method="POST">
                      <div class="form-group">
                        <label for="exampleInputUsername1">nom</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Username" name="nom">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">prenom</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Email" name="prenom">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">tel</label>
                        <input type="password" class="form-control" id="exampleInputPassword1"  name="tel">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputConfirmPassword1">adresse</label>
                        <input type="password" class="form-control" id="exampleInputConfirmPassword1"  name="adresse">
                      </div>
                              <div class="form-group">
                        <label for="exampleInputConfirmPassword1">Code Postal</label>
                        <input type="text" class="form-control" id="exampleInputConfirmPassword1" name="codePostal">
                      </div>
                              <div class="form-group">
                        <label for="exampleInputConfirmPassword1">Sexe</label>
                        <input type="text" class="form-control" id="exampleInputConfirmPassword1" name="sexe">
                      </div>
                              <div class="form-group">
                        <label for="exampleInputConfirmPassword1">Cin</label>
                        <input type="text" class="form-control" id="exampleInputConfirmPassword1" name="cin">
                      </div>
                              <div class="form-group">
                        <label for="exampleInputConfirmPassword1">Email</label>
                        <input type="email" class="form-control" id="exampleInputConfirmPassword1" name="email">
                      </div>
                              <div class="form-group">
                        <label for="exampleInputConfirmPassword1">Login</label>
                        <input type="text" class="form-control" id="exampleInputConfirmPassword1" name="login">
                      </div>
                              <div class="form-group">
...
<!-- Mirrored from www.bootstrapdash.com/demo/breeze/jquery/template/demo_1/pages/forms/basic_elements.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Nov 2019 21:18:36 GMT -->
</html>