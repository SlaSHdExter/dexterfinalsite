...
<!-- Mirrored from www.bootstrapdash.com/demo/breeze/jquery/template/demo_1/pages/tables/data-table.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Nov 2019 21:19:19 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="forms">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="../forms/advanced_elements.html">Advanced Forms</a>
                </li>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> utilisateur </h3>         <a class="btn btn-outline-primary" href="ajouterCAT.php">AJOUTER</a>
                      ...
                      <table id="order-listing" class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a class="btn btn-outline-primary" href="modiferCT.php?id=<?php echo $row['idProduitsCategorie']; ?>">Modifer</a>
                               <a class="btn btn-outline-dark" href="supprimerCT.php?id=<?php echo $row['idProduitsCategorie']; ?>">Supprimer</a>
                            </td>
                          </tr>
 <?php }  ?>
...
<!-- Mirrored from www.bootstrapdash.com/demo/breeze/jquery/template/demo_1/pages/tables/data-table.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Nov 2019 21:19:20 GMT -->
</html>