...
<!-- Mirrored from www.bootstrapdash.com/demo/breeze/jquery/template/demo_1/pages/tables/basic-table.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Nov 2019 21:19:17 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"><a href="ajouterCAT.php"> Ajouter categorie</a> </p>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php echo $row['nom'];  ?></td>
                             ...
                             <td> <a href="modiferCT.php?id=<?php echo $row['idProduitsCategorie']; ?>">MODIFER</a>- <a href="supprimerCT.php?id=<?php echo $row['idProduitsCategorie']; ?>">SUPPRIMER</a></td>
                          </tr>
                       <?php }  ?>
                        </tbody>
                      </table>
...
<!-- Mirrored from www.bootstrapdash.com/demo/breeze/jquery/template/demo_1/pages/tables/basic-table.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Nov 2019 21:19:19 GMT -->
</html>